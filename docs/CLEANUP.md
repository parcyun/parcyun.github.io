...
## ✅ 사용자 승인 후 삭제됨 (2026-07-10)
- `public/design-library/` (index + 13 컴포넌트) — 라이브 미링크 카탈로그 미러. 스킬 원본 유지.
- `public/arcade/` — `/atlas-gears/` 리다이렉트 스텁 완전 삭제(참조 0).
- `supabase/migrations/0002·0004·0005` — `0006`이 전부 대체(0004 footgun 제거). 남은 건 `0001`+`0006`.
- 참조 검색 결과 죽은 링크 0, 빌드 8p 통과.
