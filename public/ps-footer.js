...
(function () {
  ...
  style.textContent = `
    ...
    #ps-footer-root .ps-brand-fixed{position:fixed;right:20px;bottom:calc(var(--ps-footer-h,0px) + 10px);z-index:9989;display:flex;align-items:center;gap:8px;font-family:var(--ps-footer-font);font-weight:300;font-size:11px;line-height:var(--ps-footer-line);color:#8C8C8C;white-space:nowrap;background:rgba(0,0,0,.6);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);padding:4px 12px;border-radius:var(--ps-footer-radius);border:1px solid rgba(255,255,255,.08);opacity:var(--ps-footer-opacity)}
