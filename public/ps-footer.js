...
(function () {
  ...
  style.textContent = `
    ...
    #ps-footer-root{--ps-footer-primary:#FFB11A;--ps-footer-secondary:#8C8C8C;--ps-footer-font:'Montserrat','Pretendard Variable','Pretendard',sans-serif;--ps-footer-signature:'Covered By Your Grace',cursive}
    #ps-footer-root .ps-footer{position:static;flex-shrink:0;margin-top:auto;width:100%;background:rgba(0,0,0,.82);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);border-top:1px solid rgba(255,255,255,.08);font-family:'Montserrat','Pretendard Variable','Pretendard',sans-serif;line-height:normal}
