...
(function () {
  ...
  var showReview = host.getAttribute('data-show-review') !== 'false';
  ...
  style.textContent = `
    ...
    #ps-footer-root{--ps-footer-primary:#FFB11A;--ps-footer-secondary:#8C8C8C;--ps-footer-surface:rgba(0,0,0,.82);--ps-footer-font:'Montserrat','Pretendard Variable','Pretendard',sans-serif;--ps-footer-weight:400;--ps-footer-line:normal;--ps-footer-radius:100px;--ps-footer-opacity:1;--ps-footer-signature:'Covered By Your Grace',cursive}
    #ps-footer-root .ps-footer{position:static;flex-shrink:0;margin-top:auto;width:100%;background:var(--ps-footer-surface);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);border-top:1px solid rgba(255,255,255,.08);font-family:'Montserrat','Pretendard Variable','Pretendard',sans-serif;font-family:var(--ps-footer-font);font-weight:var(--ps-footer-weight);line-height:var(--ps-footer-line);opacity:var(--ps-footer-opacity)}
    ...
    #ps-footer-root .ps-flinks{display:flex;flex-wrap:wrap;align-items:center;gap:0;row-gap:4px;line-height:normal}#ps-footer-root .ps-flink{font-family:var(--ps-footer-font);font-size:11px;font-weight:400;line-height:normal;letter-spacing:.3px;color:#8C8C8C;text-decoration:none;background:transparent;border:0;cursor:pointer;padding:0 10px;border-right:1px solid rgba(255,255,255,.14);transition:color .18s}#ps-footer-root .ps-flink:last-of-type{border-right:0}#ps-footer-root .ps-flink:first-child{padding-left:0}#ps-footer-root .ps-flink:hover{color:#fff}
    #ps-footer-root .ps-brand-fixed{position:fixed;right:20px;bottom:calc(var(--ps-footer-h,0px) + 10px);z-index:9989;display:flex;align-items:center;gap:8px;font-family:var(--ps-footer-font);font-weight:300;font-size:var(--ps-footer-size,11px);line-height:var(--ps-footer-line);letter-spacing:var(--ps-footer-spacing,normal);color:#8C8C8C;white-space:nowrap;background:rgba(0,0,0,.6);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);padding:var(--ps-footer-padding,4px 12px);margin:var(--ps-footer-margin,0);border-radius:var(--ps-footer-radius);border:var(--ps-footer-border-width,1px) solid var(--ps-footer-border,rgba(255,255,255,.08));opacity:var(--ps-footer-opacity)}
    #ps-footer-root .ps-brand-coffee,#ps-footer-root .ps-brand-feedback,#ps-footer-root .ps-brand-review{display:inline-flex;align-items:center;gap:4px;font-family:var(--ps-footer-font);font-size:11px;font-weight:400;line-height:normal;letter-spacing:.3px;background:transparent;border:0;border-right:1px solid rgba(255,255,255,.14);padding:0 10px 0 0;cursor:pointer;transition:color .18s;text-decoration:none}#ps-footer-root .ps-brand-coffee{color:#FFB11A}#ps-footer-root .ps-brand-feedback,#ps-footer-root .ps-brand-review{color:#8C8C8C}#ps-footer-root .ps-brand-coffee:hover,#ps-footer-root .ps-brand-feedback:hover,#ps-footer-root .ps-brand-review:hover,#ps-footer-root .ps-ig:hover{color:#FFB11A}
    #ps-footer-root .ico{display:inline-flex;align-items:center;justify-content:center;line-height:0}#ps-footer-root .ico svg{display:block}#ps-footer-root .ps-brand-text{display:inline-flex;align-items:center;gap:8px;font-family:var(--ps-footer-font);font-weight:300;font-size:11px;line-height:normal;color:#8C8C8C}#ps-footer-root .ps-signature{font-family:var(--ps-footer-signature);font-size:15px;font-weight:300;color:#FFB11A;line-height:1}#ps-footer-root .ps-ig{display:inline-flex;align-items:center;gap:3px;font-family:var(--ps-footer-font);font-weight:300;font-size:11px;line-height:normal;color:#8C8C8C;text-decoration:none}#ps-footer-root .ps-ig-icon{width:10px;height:10px;vertical-align:middle}
    #ps-footer-root .coffee-modal{position:fixed;inset:0;z-index:10000;display:flex;align-items:center;justify-content:center;padding:24px;font-family:var(--ps-footer-font);line-height:normal}#ps-footer-root .coffee-modal[hidden]{display:none}#ps-footer-root .coffee-backdrop{position:absolute;inset:0;background:rgba(0,0,0,.72);backdrop-filter:blur(6px);-webkit-backdrop-filter:blur(6px);animation:psCoffeeFade .2s ease}#ps-footer-root .coffee-card{position:relative;z-index:1;background:#141414;border:1px solid #FFB11A;border-radius:18px;padding:32px 32px 26px;text-align:center;max-width:380px;width:100%;box-shadow:0 24px 60px rgba(0,0,0,.6),0 0 40px rgba(255,177,26,.12);animation:psCoffeePop .28s cubic-bezier(.16,1,.3,1)}@keyframes psCoffeeFade{from{opacity:0}to{opacity:1}}@keyframes psCoffeePop{from{opacity:0;transform:translateY(16px) scale(.96)}to{opacity:1;transform:none}}#ps-footer-root .coffee-close{position:absolute;top:12px;right:16px;background:transparent;border:0;color:#8C8C8C;font-size:24px;line-height:1;cursor:pointer}#ps-footer-root .coffee-close:hover{color:#FFB11A}#ps-footer-root .coffee-emoji{display:flex;align-items:center;justify-content:center;color:#FFB11A;margin-bottom:10px}#ps-footer-root .coffee-title{margin:0 0 8px;font-family:var(--ps-footer-font);font-size:19px;font-weight:500;line-height:1.35;color:#fff}#ps-footer-root .coffee-sub{margin:0 0 20px;font-family:var(--ps-footer-font);font-size:13px;font-weight:300;line-height:1.7;color:#8C8C8C}#ps-footer-root .coffee-email{display:block;margin:0 auto 16px;padding:14px 16px;border:1px solid rgba(255,177,26,.55);border-radius:10px;background:#0b0b0b;color:#FFB11A;font-family:var(--ps-footer-font);font-size:15px;font-weight:500;letter-spacing:.01em;text-decoration:none;user-select:all}#ps-footer-root .coffee-actions{display:flex;justify-content:center;align-items:center;gap:8px}#ps-footer-root .coffee-copy,#ps-footer-root .coffee-mail{display:inline-flex;align-items:center;justify-content:center;min-height:36px;padding:0 14px;border-radius:999px;font-family:var(--ps-footer-font);font-size:11px;font-weight:500;cursor:pointer;text-decoration:none}#ps-footer-root .coffee-copy{border:1px solid rgba(255,255,255,.22);background:transparent;color:#fff}#ps-footer-root .coffee-mail{border:1px solid #FFB11A;background:#FFB11A;color:#16120a}
    @media(max-width:480px){#ps-footer-root .ps-brand-fixed{right:14px;font-size:10px;padding:3px 10px;gap:6px}#ps-footer-root .coffee-card{padding-left:20px;padding-right:20px}#ps-footer-root .coffee-actions{flex-direction:column}#ps-footer-root .coffee-copy,#ps-footer-root .coffee-mail{width:100%}}
  `;
