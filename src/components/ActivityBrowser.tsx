  ...
  return (
    <div className="ab">
      ...
      <style>{`
        ...
        .act-hot{display:inline-flex;align-items:center;border:0;border-radius:100px;padding:2px 8px;background:#D96A6A;color:#fff;font-family:var(--ps-font-en);font-size:10px;font-weight:700;letter-spacing:.08em;line-height:16px}
