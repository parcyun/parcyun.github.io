...
const PREVIEW_DESCRIPTION_BY_NUM: Record<string, string> = {
  ...
  '004': 'MDBF 공식 웹사이트의 색상·서체·오브젝트·섹션을 출처와 함께 정리한 표준 카탈로그입니다. JSON 명세와 CSS 토큰을 함께 내려받을 수 있습니다.',
  '005': 'the Masterclass의 공용 크롬, 콘텐츠 카드, 캐러셀, 상세 화면과 접근 제어를 하나의 제품 문법으로 정리한 표준 카탈로그입니다.',
};
...
const PREVIEW_IMAGE_BY_NUM: Record<string, string> = {
  ...
  '004': '/images/work-previews/004.png',
  '005': '/images/work-previews/005.png',
};
