...
export const STR = {
  ko: {
    title:'세계 지도', subtitle:'6대륙 5대양', kicker:'World Map · Interactive · v1.3.2',
    ...
    // 가이드
    gTools:'← 지도 도구: 격자·세계의 기후·세계의 지형·위성사진·낮과 밤·실제 크기 비교',
  ...
  en: {
    title:'World Map', subtitle:'6 Continents · 5 Oceans', kicker:'World Map · Interactive · v1.3.2',
    ...
    gTools:'← Map tools: grid · climates · landforms · satellite · day/night · true size',
