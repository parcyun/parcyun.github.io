...
test('ACADEMICA and ATLAS cards share an image and summary hover preview', async () => {
  ...
  for (const id of ['academica', 'llm-fundamentals', 'agentic-ai', 'notion-onboarding', 'ai-edtech-tools', 'edubeige', 'yearly-life-archive', 'math-volume', 'world-city-research', 'world-map', 'ai-class', 'kocomate', 'zoomit', 'snipaste']) {
